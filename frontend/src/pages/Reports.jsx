    ...
    <div className="reports-page fade-in">
      ...
      {searched && !loading && reports.length === 0 && (
        <EmptyState
          ...
          title="No Intelligence Report Found"
          description={`No report exists for "${company}". Run the intelligence pipeline to generate a structured report with verified signals and confidence scores.`}
          buttonText="Generate Report"
          buttonIcon={<HiOutlineSearch />}
          onClick={() => navigate('/intelligence', {
            state: { autoRunCompany: company.trim() }
          })}
          hint="Reports are generated by the AI pipeline and saved automatically"
        />
      )}
