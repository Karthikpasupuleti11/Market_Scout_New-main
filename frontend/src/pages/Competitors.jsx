  ...
  return (
    <div className="competitors-page fade-in">
      <SectionHeader
        ...
        subtitle="Monitor and track companies across your intelligence landscape"
        loading={loading}
        onRefresh={load}
      />
      ...
      {!loading && competitors.length === 0 && (
        <div className="empty-state">
          ...
          <p>
            Run the intelligence pipeline on a company to start tracking them.
          </p>
          <button
          ...
          {[...competitors]
            ...
            .map((comp, i) => {
              ...
              return (
                <div
                  key={comp.id || i}
                  className={`card watchlist-card fade-in-up`}
                >
                  ...
                  {data && (
                    <div className="wl-stats-row">
                      <span className="wl-stat">
                        <strong>{data.signals}</strong> signals
                      </span>
                      <span className="wl-stat">
          ...
          >
            ...
            <div className="modal-body">
              ...
              <p className="modal-warning">
                All associated reports and extracted features will be
